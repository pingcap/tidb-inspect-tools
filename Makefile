...
default: snapshot-collector

all: check test snapshot-collector

snapshot-collector:
	$(GOBUILD) -o bin/snapshot-collector cmd/snapshot-collector/snapshot-collector.go
...
.PHONY: all test clean tidb-inspector-tools
